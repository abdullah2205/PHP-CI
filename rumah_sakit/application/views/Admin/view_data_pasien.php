                            ...
                            <?php $no=1;foreach ($values as $value): ?>
                                <tr>
                                    ...
                                    <td width="180">
                                        ...
                                        <a onclick="deleteConfirm('<?php echo site_url('c_admin/delete_data_pasien/'.$value->id_pasien) ?>')"
        ...
        <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="tambah-data" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <?php echo form_open_multipart('c_admin/insert_data_pasien') ?>
        ...
        <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="ubah-data" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <?php echo form_open_multipart('c_admin/update_data_pasien') ?>
                        <div class="modal-body">
                            <div class="form-group">
                                <div class="col-lg-12">
